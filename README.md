...
- **🖥️ Windows**: **Primary solution** (Docker containers can't access Windows audio)
...
Include `radio_stations.json` and `config.env` in off-site backups if they contain irreplaceable customizations.
